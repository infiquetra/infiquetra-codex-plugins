...
class DispatcherLeaseTransientError(DispatcherError):
    """A lease-LIFECYCLE transient at the dispatch seam (#627/#637 R4/KTD2): a refuse-mode admission
    ...
    def _dispatch(req: Any) -> dict[str, Any]:
        ...
        if selected is not None:
            try:
                ...
                # at admission with a typed conflict, classified by the normalize arm below, rather
                # than silently superseding the peer and double-preparing the leaf.
