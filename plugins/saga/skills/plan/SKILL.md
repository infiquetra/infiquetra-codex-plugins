...
exactly two backends — `inline | team-execution`. Read the work shape,
...
`team-execution` for broad independent fan-out without elevated risk. Never offer source-only
workflow backends in Codex.
