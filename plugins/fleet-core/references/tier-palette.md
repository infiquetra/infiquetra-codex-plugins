...
<!-- BEGIN EXECUTION CLASS TABLE (must agree with models.json and tier_resolver tests) -->
...
profile resolution. Ultra is separate root orchestration behavior because it adds
