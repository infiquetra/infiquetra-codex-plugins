...
| `team-execution` | reviewer consensus, selected validators, delegated or serial evidence | final mutation approval, scope decisions, deployment ownership |
...
| Reviewer protocol belongs to `team-execution` | Saga can recommend escalation, but Team Execution owns selected reviewers, validators, and evidence. |
...
| `saga:plan`, `saga:work`, or `saga:doc-review` | `team-execution:team-execution` | The work needs independent consensus, selected validators, or broad fan-out. |
