...
# Rotated 2026-08-16 for the mission-control 2.5.0 dispatch-marker retirement decision. The journal
# remains `historical-evidence`, so the prospective correction moves this digest by design. Keep the
# pin paired with the inventory regenerated by `scripts/build_legacy_workflow_inventory.py --write`
# in the same commit as the journal edit.
LEGACY_WORKFLOW_HISTORICAL_INVENTORY_SHA256 = (
    "484450d23606c93cb849fc2a7982ade0ab781e4e6c450528335133c69f006d73"
)
