...
HERMES_PROFILE_EVOLUTION_PRODUCER_PINS = (
    ...
    },
    {
        ...
        "source_commit": "435b3660e86c41819462bc2b918d49c07a8497a6",
        "merge_commit": "0fb5dfbc68c21732758167b613658f2a2a7ab9bc",
        "schema_version": 1,
        "fixture_version": 1,
        "imported_path": "plugins/hermes-profile-evolution/conformance/profile-request-cli.v1.json",
        "sha256": "31bb58621853cf42814c15df68dde37db2d992bb675f012ff69ba37b66e01f72",
    },
)
...
# Rotated 2026-08-10 for the issue #63 plan decisions. `docs/engineering-journal/DECISIONS.md` is
# classified `historical-evidence`, so appending to it moves this digest by design: the pin is
# what makes an edit to a historical-evidence file a reviewed act rather than a silent one.
# Rotate it only alongside the inventory regenerated by
# `scripts/build_legacy_workflow_inventory.py --write`, in the same commit as the edit.
LEGACY_WORKFLOW_HISTORICAL_INVENTORY_SHA256 = (
    "aec895fbd7c24716fdddaa7111fa817b352949fe42f84d66c0e1083721fe671b"
)
