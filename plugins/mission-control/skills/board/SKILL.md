...
name: board
description: |
  Manage the Infiquetra GitHub Projects boards: Jeff Intent, Asgard, and CAMPPS.
...
The command archives terminal workflow items. For Jeff Intent, Asgard, and CAMPPS that means `Done`.
