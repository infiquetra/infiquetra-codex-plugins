...
# Rotated 2026-08-11 for the reviewed issue #63 version 6 lifecycle decision. The journal remains
# `historical-evidence`, so the prospective correction moves this digest by design. Keep the pin
# paired with the inventory regenerated by `scripts/build_legacy_workflow_inventory.py --write` in
# the same commit as the journal edit.
LEGACY_WORKFLOW_HISTORICAL_INVENTORY_SHA256 = (
    "f8f97c7a2039256bcb84c9eba6613ce3f8e10415cb8a3d4ed4cfcabd31c8e6af"
)
