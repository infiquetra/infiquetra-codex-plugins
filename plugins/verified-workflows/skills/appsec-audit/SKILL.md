...
description: |
  ...
  redirects, metadata endpoints, allowlists, and evidence-backed findings. Use when reviewing
  code that accepts URLs, fetches remote resources, follows redirects, proxies requests, imports
  external data, parses user-controlled input, or touches network egress controls.
---
